...
**Both repos are pushed and up to date** — track-insights-main `1bd80d1`, athletics-predictor `8c169fec`. (The medal→rank API change and the frontend nav/emoji/de-box work described below were committed separately, per repo, then both pushed.)
